...
export const COFFEE_BEANS: CoffeeBean[] = [
  {
    ...
    shortSummary: 'Café de altura andina, aromático y especiado con notas frutales y caramelo.',
    representation: 'En taza expresa vivacidad aromática, notas de clavo y canela, y un final suave y acaramelado.',
    personality: {
    ...
    roastTitle: 'Medio/Alto',
    roastDesc: 'Intenso y aromático',
    roastPercentage: 80,
    acidityTitle: 'Media/Baja',
    acidityPercentage: 40,
    bodyTitle: 'Medio',
    bodyDesc: 'Suave y cremoso',
    bodyPercentage: 55,
    prices: {
      '250g': 20000,
      '500g': 38000,
    ...
    accentColor: '#d49a55',
    flavorTags: ['Chocolate y caramelo', 'Clavo y canela', 'Frutas Tropicales'],
  ...
  },
  {
    ...
    region: 'Minas Gerais',
    country: 'Brasil',
    altitude: '800–1200 msnm',
    shortSummary: 'Clásico brasileño de secado natural al sol, suntuosamente equilibrado y dulce.',
    representation: 'En taza expresa cuerpo equilibrado, notas dulces de caramelo y frutos secos, sin estridencias ácidas.',
    personality: {
    ...
    roastTitle: 'Medio',
    roastDesc: 'Secado natural',
    roastPercentage: 50,
    acidityTitle: 'Media',
    acidityPercentage: 50,
    bodyTitle: 'Medio',
    ...
    accentColor: '#c6894b',
    flavorTags: ['Cacao tostado', 'Frutas secas y nueces', 'Caramelo'],
  ...
  },
  {
    ...
    altitude: '900–1200 msnm',
    shortSummary: 'Tueste oscuro de tradición alpina, cuerpo contundente, notas ahumadas y tostadas.',
    representation: 'En taza entrega crema densa, profundo chocolate amargo, retrogusto ahumado y presencia imponente.',
    personality: {
    ...
    roastTitle: 'Intenso',
    roastDesc: 'Ahumado y oscuro',
    roastPercentage: 95,
    acidityTitle: 'Baja',
    acidityPercentage: 20,
    bodyTitle: 'Denso',
    bodyDesc: 'Cuerpo pleno',
    bodyPercentage: 100,
    prices: {
      '250g': 19000,
      '500g': 36000,
    ...
    accentColor: '#9e6231',
    flavorTags: ['Chocolate amargo', 'Frutos secos y caramelo', 'Nuez moscada'],
